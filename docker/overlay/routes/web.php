...
Route::get('/settings/themes',[ThemeController::class,'index'])->name('settings.themes');
Route::post('/settings/themes',[ThemeController::class,'update'])->name('settings.themes.update');
