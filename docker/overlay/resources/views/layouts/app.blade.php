...
<html lang="{{ app()->getLocale() }}">
    ...
    (function(){
        ...
        (function tick(){
            if(active){
                ...
                var ev=new MouseEvent('mousemove',{clientX:sx,clientY:sy,bubbles:true});
    ...
    <script>window.__HEIMDALL_THEME__={slug:"{{$activeTheme->slug}}",variant:"{{$activeTheme->currentVariant()}}",multiVariant:{{$activeTheme->isMultiVariant()?"true":"false"}},backgrounds:{!!$activeTheme->backgroundsJson()!!},imageBaseUrl:"{{config('heimdall-themes.image_url','')}}"};</script>
            ...
            <div class="content">
                ...
                <main id="main">
                    ...
                    <div id="config-buttons">
                        ...
                        <a id="themes" class="config" href="{{ route('settings.themes') }}" style="font-size:1.1em;line-height:1;">&#9685;<div class="tooltip left">Themes</div></a>
                    </div>
                    @endif
                </main>
